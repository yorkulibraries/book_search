...
class Sl2::ChangeRequestorControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  should "show edit form" do
    ...
    get edit_sl2_change_requestor_path(ticket), xhr: true
  ...
  should "change requestor if one is found" do
    ...
    patch sl2_change_requestor_path(ticket), xhr: true, params: { patron: {login_id: p.login_id } }
  ...
  should "not change requestor if one is not found" do
    ...
    patch sl2_change_requestor_path(ticket), xhr: true, params: { patron: {login_id: "234234" } }
